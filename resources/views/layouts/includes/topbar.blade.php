<!-- Topbar Start -->
            <div class="navbar navbar-expand flex-column flex-md-row navbar-custom">
                <div class="container-fluid">
                    <!-- LOGO -->
                    <a href="{{url('index.html')}}" class="navbar-brand mr-0 mr-md-2 logo">
                        <span class="logo-lg">
                    ...
                    <ul class="navbar-nav flex-row ml-auto d-flex list-unstyled topnav-menu float-right mb-0">
                        ...
                        <li class="dropdown d-none d-lg-block" data-toggle="tooltip" data-placement="left" title="Change language">
                            <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="{{url('index.html#')}}" role="button"
                        ...
                        <li class="dropdown notification-list" data-toggle="tooltip" data-placement="left"
                            ...
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="{{url('index.html#')}}" role="button" aria-haspopup="false"
                                aria-expanded="false">
                                ...
                                <div class="dropdown-item noti-title border-bottom">
                                    <h5 class="m-0 font-size-16">
                                        <span class="float-right">
                                            <a href="{{url('index.html')}}" class="text-dark">
                        ...
                        <li class="dropdown notification-list align-self-center profile-dropdown">
                            <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="{{url('index.html#')}}" role="button"
                                aria-haspopup="false" aria-expanded="false">
