        ...
        <div class="content-page">
                    ...
                    <div class="row page-title">
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('pages-profile.html#')}}">Shreyu</a></li>
                                    <li class="breadcrumb-item"><a href="{{url('pages-profile.html#')}}">Pages</a></li>
                                    ...
                                    <ul class="nav nav-pills navtab-bg nav-justified" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-activity-tab" data-toggle="pill"
                                                href="{{url('pages-profile.html#pills-activity')}}" role="tab" aria-controls="pills-activity"
                                                aria-selected="true">
                                                Orders
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-messages-tab" data-toggle="pill"
                                                href="{{url('pages-profile.html#pills-messages')}}" role="tab" aria-controls="pills-messages"
                                                aria-selected="false">
                                                Orders
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-projects-tab" data-toggle="pill"
                                                href="{{url('pages-profile.html#pills-projects')}}" role="tab" aria-controls="pills-projects"
                                                aria-selected="false">
                                                Orders
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-tasks-tab" data-toggle="pill"
                                                href="{{url('pages-profile.html#pills-tasks')}}" role="tab" aria-controls="pills-tasks"
                                                aria-selected="false">
                                                Orders
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-files-tab" data-toggle="pill"
                                                href="{{url('pages-profile.html#pills-files')}}" role="tab" aria-controls="pills-files"
                                                aria-selected="false">
                                                Orders
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        aria-labelledby="pills-messages-tab">
                                                ...
                                                <li class="py-3 border-bottom">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body overflow-hidden">
                                                            <h5 class="font-size-15 mt-2 mb-1"><a href="pages-profile.html#"
                                            ...
                                            <div class="text-center">
                                                <a href="pages-profile.html#" class="btn btn-primary btn-sm">Load more</a>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-success text-uppercase font-size-12 mb-2">Web
                                                                Design</p>
                                                            <h5><a href="pages-profile.html#" class="text-dark">Landing page Design</a>
                                                            </h5>
                                                    ...
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-warning text-uppercase font-size-12 mb-2">
                                                                Android</p>
                                                            <h5><a href="pages-profile.html#" class="text-dark">App Design and Develop</a>
                                                            </h5>
                                                ...
                                                <div class="col-xl-4 col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-success text-uppercase font-size-12 mb-2">Web
                                                                Design</p>
                                                            <h5><a href="pages-profile.html#" class="text-dark">New Admin Design</a></h5>
                                                ...
                                                <div class="col-xl-4 col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-warning text-uppercase font-size-12 mb-2">
                                                                Android</p>
                                                            <h5><a href="pages-profile.html#" class="text-dark">Custom Software
                                                                    Development</a></h5>
                                                ...
                                                <div class="col-xl-4 col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-success text-uppercase font-size-12 mb-2">Web
                                                                Design</p>
                                                            <h5><a href="pages-profile.html#" class="text-dark">Brand logo design</a></h5>
                                                ...
                                                <div class="col-xl-4 col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-success text-uppercase font-size-12 mb-2">Web
                                                                Design</p>
                                                            <h5><a href="pages-profile.html#" class="text-dark">Website Redesign</a></h5>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            2020 &copy; Courier. All Rights Reserved. Crafted with <i class='uil uil-heart text-danger font-size-12'></i> by <a href="https://coderthemes.com" target="_blank">Liberty Breeze</a>
                        </div>
                    </div>
                </div>
            </footer>
