            ...
            <div class="content-page">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="card">
                                    <div class="card-body pb-0">
                                        <ul class="nav card-nav float-right">
                                            <li class="nav-item">
                                                <a class="nav-link text-muted" href="{{url('index.html#')}}">Today</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-muted" href="{{url('index.html#')}}">7d</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" href="{{url('index.html#')}}">15d</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-muted" href="{{url('index.html#')}}">1m</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-muted" href="{{url('index.html#')}}">1y</a>
                                            </li>
                                        </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="{{url('index.html')}}" class="btn btn-primary btn-sm float-right">
                                    ...
                                    <div class="card-body pt-2">
                                        ...
                                        <div class="media border-top pt-3">
                                            ...
                                            <div class="dropdown align-self-center float-right">
                                                <a href="{{url('index.html#')}}" class="dropdown-toggle arrow-none text-muted" data-toggle="dropdown"
                                                    aria-expanded="false">
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-body pt-2 pb-3">
                                        <a href="{{url('task-list.html')}}" class="btn btn-primary btn-sm mt-2 float-right">
                                            View All
                                        </a>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                2020 &copy; Courier Services  <i class='uil uil-heart text-danger font-size-12'></i> by <a href="{{url('https://coderthemes.com')}}" target="_blank">Liberty Breeze Global Systems</a>
                            </div>
                        </div>
                    </div>
                </footer>
